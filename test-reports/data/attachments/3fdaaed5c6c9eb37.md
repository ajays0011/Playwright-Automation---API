...
- Name: bookstore/bookstore.security.spec.ts >> BookStore API - Security Tests @security >> SQL Injection Prevention @security >> should reject SQL injection in ISBN query parameter @security
- Location: tests/bookstore/bookstore.security.spec.ts:22:9
