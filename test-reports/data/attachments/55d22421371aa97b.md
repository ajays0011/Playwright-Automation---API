...
- Name: account/user.security.spec.ts >> User API - Security Tests @security >> Unsupported HTTP Methods @security >> should reject PUT on GenerateToken endpoint @security
- Location: tests/account/user.security.spec.ts:116:9
