...
- Name: bookstore/collection.positive.spec.ts >> Collection Management - Positive Tests >> Clear All Books @integration @regression >> should delete all books from user collection @integration
- Location: tests/bookstore/collection.positive.spec.ts:179:9
