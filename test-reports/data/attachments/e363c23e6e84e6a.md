...
- Name: account/user.security.spec.ts >> User API - Security Tests @security >> SQL Injection Prevention @security >> should reject SQL injection in username field @security
- Location: tests/account/user.security.spec.ts:26:9
